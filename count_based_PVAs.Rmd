...
lambdas <- c(1.00, 1.98, 1.02, 0.92, 0.53) # different lambda values to use for simulation.  There can be as many as you want.  For this simulation, each will be drawn with an equal probability.
...
year_5_hist <- ggplot(year_5_pop_sizes, aes(x=pop_sizes_simulation[5, ])) + geom_histogram() + xlab("") # creates the histogram

# Plots the distribution of population sizes after 20 years in the simulation
...
# Plots the distribution of population sizes after 100 years in the simulation
